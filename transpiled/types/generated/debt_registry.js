    ...
    constructor(web3ContractInstance, defaults) {
        ...
        this.getTermsContractParameters = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.getTermsContractParameters.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
        ...
        this.modifyBeneficiary = {
            sendTransactionAsync(agreementId, newBeneficiary, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData, self.modifyBeneficiary.estimateGasAsync.bind(self, agreementId, newBeneficiary));
                    const txHash = yield utils_1.promisify(self.web3ContractInstance.modifyBeneficiary, self.web3ContractInstance)(agreementId, newBeneficiary, txDataWithDefaults);
                    return txHash;
                });
            },
            estimateGasAsync(agreementId, newBeneficiary, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const gas = yield utils_1.promisify(self.web3ContractInstance.modifyBeneficiary.estimateGas, self.web3ContractInstance)(agreementId, newBeneficiary, txDataWithDefaults);
                    return gas;
                });
            },
            getABIEncodedTransactionData(agreementId, newBeneficiary, txData = {}) {
                const self = this;
        ...
        this.getTerms = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.getTerms.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
        ...
        this.get = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.get.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
        ...
        this.doesEntryExist = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.doesEntryExist.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
        ...
        this.getBeneficiary = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.getBeneficiary.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
        ...
        this.getIssuanceBlockTimestamp = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.getIssuanceBlockTimestamp.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
        ...
        this.getTermsContract = {
            callAsync(agreementId, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.getTermsContract.call, self.web3ContractInstance)(agreementId);
                    return result;
                });
            }
        };
