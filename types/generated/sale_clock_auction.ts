...
export class SaleClockAuctionContract extends BaseContract {
  public createAuction = {
    async sendTransactionAsync(
      ...
      const self = this as SaleClockAuctionContract;
  ...
  public lastGen0SalePrices = {
    async callAsync(
      ...
      const result = await promisify<BigNumber>(
        self.web3ContractInstance.lastGen0SalePrices.call,
        self.web3ContractInstance
      )(index_0);
      return result;
    }
  ...
  public isSaleClockAuction = {
    async callAsync(defaultBlock?: Web3.BlockParam): Promise<boolean> {
      const self = this as SaleClockAuctionContract;
      const result = await promisify<boolean>(
        self.web3ContractInstance.isSaleClockAuction.call,
        self.web3ContractInstance
      )();
      return result;
    }
  ...
  public gen0SaleCount = {
    async callAsync(defaultBlock?: Web3.BlockParam): Promise<BigNumber> {
      const self = this as SaleClockAuctionContract;
      const result = await promisify<BigNumber>(
        self.web3ContractInstance.gen0SaleCount.call,
        self.web3ContractInstance
      )();
      return result;
    }
  ...
  public averageGen0SalePrice = {
    async callAsync(defaultBlock?: Web3.BlockParam): Promise<BigNumber> {
      const self = this as SaleClockAuctionContract;
      const result = await promisify<BigNumber>(
        self.web3ContractInstance.averageGen0SalePrice.call,
        self.web3ContractInstance
      )();
      return result;
    }
  ...
  static async deployed(
  ...
  ): Promise<SaleClockAuctionContract> {
    ...
    return new SaleClockAuctionContract(web3ContractInstance, defaults);
  }
  static async at(
    address: string,
    web3: Web3,
  ...
  private static async getArtifactsData(web3: Web3): Promise<any> {
    try {
      const artifact = await fs.readFile(
        "build/contracts/SaleClockAuction.json",
        "utf8"
      );
