...
export class ClockAuctionContract extends BaseContract {
  public createAuction = {
    async sendTransactionAsync(
      ...
      const self = this as ClockAuctionContract;
  ...
  static async deployed(
    ...
    return new ClockAuctionContract(web3ContractInstance, defaults);
  }
  static async at(
    address: string,
    web3: Web3,
  ...
  private static async getArtifactsData(web3: Web3): Promise<any> {
    try {
      const artifact = await fs.readFile(
        "build/contracts/ClockAuction.json",
        "utf8"
      );
