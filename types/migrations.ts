...
export class MigrationsContract extends BaseContract {
  public upgrade = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
        txData,
        self.upgrade.estimateGasAsync.bind(self, newAddress)
      );
      const txHash = await promisify<string>(
        self.web3ContractInstance.upgrade,
        self.web3ContractInstance
      )(newAddress, txDataWithDefaults);
      return txHash;
    },
    async estimateGasAsync(
      ...
      const gas = await promisify<number>(
        self.web3ContractInstance.upgrade.estimateGas,
        self.web3ContractInstance
      )(newAddress, txDataWithDefaults);
      return gas;
    },
  ...
  public setCompleted = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
        txData,
        self.setCompleted.estimateGasAsync.bind(self, completed)
      );
      const txHash = await promisify<string>(
        self.web3ContractInstance.setCompleted,
        self.web3ContractInstance
      )(completed, txDataWithDefaults);
      return txHash;
    },
    async estimateGasAsync(
      completed: BigNumber,
      ...
      const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(txData);
      const gas = await promisify<number>(
        self.web3ContractInstance.setCompleted.estimateGas,
        self.web3ContractInstance
      )(completed, txDataWithDefaults);
      return gas;
    },
